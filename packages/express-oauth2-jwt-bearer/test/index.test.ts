...
describe('index', () => {
  ...
  it('should succeed when required scopes are included as scope alias', async () => {
  ...
  it('should succeed when required scopes are included as scp alias', async () => {
  ...
  it('should succeed when required scopes are included as scopes alias', async () => {
